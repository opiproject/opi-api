...
func (c *nullVolumeServiceClient) CreateNullVolume(ctx context.Context, in *CreateNullVolumeRequest, opts ...grpc.CallOption) (*NullVolume, error) {
	...
	out := new(NullVolume)
	err := c.cc.Invoke(ctx, NullVolumeService_CreateNullVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nullVolumeServiceClient) DeleteNullVolume(ctx context.Context, in *DeleteNullVolumeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, NullVolumeService_DeleteNullVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nullVolumeServiceClient) UpdateNullVolume(ctx context.Context, in *UpdateNullVolumeRequest, opts ...grpc.CallOption) (*NullVolume, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NullVolume)
	err := c.cc.Invoke(ctx, NullVolumeService_UpdateNullVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nullVolumeServiceClient) ListNullVolumes(ctx context.Context, in *ListNullVolumesRequest, opts ...grpc.CallOption) (*ListNullVolumesResponse, error) {
	...
	err := c.cc.Invoke(ctx, NullVolumeService_ListNullVolumes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nullVolumeServiceClient) GetNullVolume(ctx context.Context, in *GetNullVolumeRequest, opts ...grpc.CallOption) (*NullVolume, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NullVolume)
	err := c.cc.Invoke(ctx, NullVolumeService_GetNullVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nullVolumeServiceClient) StatsNullVolume(ctx context.Context, in *StatsNullVolumeRequest, opts ...grpc.CallOption) (*StatsNullVolumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, NullVolumeService_StatsNullVolume_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNullVolumeServiceServer must be embedded to have
...
func (UnimplementedNullVolumeServiceServer) testEmbeddedByValue()                           {}
...
func RegisterNullVolumeServiceServer(s grpc.ServiceRegistrar, srv NullVolumeServiceServer) {
	// If the following call pancis, it indicates UnimplementedNullVolumeServiceServer was
...
var NullVolumeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "storage/backend_null.proto",
}
