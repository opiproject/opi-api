...
func (c *frontendVirtioBlkServiceClient) CreateVirtioBlk(ctx context.Context, in *CreateVirtioBlkRequest, opts ...grpc.CallOption) (*VirtioBlk, error) {
	...
	out := new(VirtioBlk)
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_CreateVirtioBlk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendVirtioBlkServiceClient) DeleteVirtioBlk(ctx context.Context, in *DeleteVirtioBlkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_DeleteVirtioBlk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendVirtioBlkServiceClient) UpdateVirtioBlk(ctx context.Context, in *UpdateVirtioBlkRequest, opts ...grpc.CallOption) (*VirtioBlk, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VirtioBlk)
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_UpdateVirtioBlk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendVirtioBlkServiceClient) ListVirtioBlks(ctx context.Context, in *ListVirtioBlksRequest, opts ...grpc.CallOption) (*ListVirtioBlksResponse, error) {
	...
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_ListVirtioBlks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendVirtioBlkServiceClient) GetVirtioBlk(ctx context.Context, in *GetVirtioBlkRequest, opts ...grpc.CallOption) (*VirtioBlk, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VirtioBlk)
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_GetVirtioBlk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendVirtioBlkServiceClient) StatsVirtioBlk(ctx context.Context, in *StatsVirtioBlkRequest, opts ...grpc.CallOption) (*StatsVirtioBlkResponse, error) {
	...
	err := c.cc.Invoke(ctx, FrontendVirtioBlkService_StatsVirtioBlk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedFrontendVirtioBlkServiceServer must be embedded to have
...
func (UnimplementedFrontendVirtioBlkServiceServer) testEmbeddedByValue() {}
...
func RegisterFrontendVirtioBlkServiceServer(s grpc.ServiceRegistrar, srv FrontendVirtioBlkServiceServer) {
	// If the following call pancis, it indicates UnimplementedFrontendVirtioBlkServiceServer was
...
var FrontendVirtioBlkService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "storage/frontend_virtio_blk.proto",
}
