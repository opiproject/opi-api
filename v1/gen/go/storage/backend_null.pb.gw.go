...
var filter_NullVolumeService_CreateNullVolume_0 = &utilities.DoubleArray{Encoding: map[string]int{"null_volume": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_NullVolumeService_CreateNullVolume_0(ctx context.Context, marshaler runtime.Marshaler, client NullVolumeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq CreateNullVolumeRequest
		metadata runtime.ServerMetadata
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq.NullVolume); err != nil && !errors.Is(err, io.EOF) {
...
var filter_NullVolumeService_DeleteNullVolume_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_NullVolumeService_DeleteNullVolume_0(ctx context.Context, marshaler runtime.Marshaler, client NullVolumeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DeleteNullVolumeRequest
		metadata runtime.ServerMetadata
		err      error
	)
...
var filter_NullVolumeService_UpdateNullVolume_0 = &utilities.DoubleArray{Encoding: map[string]int{"null_volume": 0, "name": 1}, Base: []int{1, 2, 1, 0, 0}, Check: []int{0, 1, 2, 3, 2}}
...
func request_NullVolumeService_UpdateNullVolume_0(ctx context.Context, marshaler runtime.Marshaler, client NullVolumeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq UpdateNullVolumeRequest
		metadata runtime.ServerMetadata
		err      error
	)
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.NullVolume); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var filter_NullVolumeService_ListNullVolumes_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func request_NullVolumeService_ListNullVolumes_0(ctx context.Context, marshaler runtime.Marshaler, client NullVolumeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListNullVolumesRequest
		metadata runtime.ServerMetadata
	)
	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
...
func request_NullVolumeService_StatsNullVolume_0(ctx context.Context, marshaler runtime.Marshaler, client NullVolumeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq StatsNullVolumeRequest
		metadata runtime.ServerMetadata
		err      error
	)
	val, ok := pathParams["name"]
...
func RegisterNullVolumeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NullVolumeServiceServer) error {
	mux.Handle(http.MethodPost, pattern_NullVolumeService_CreateNullVolume_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodDelete, pattern_NullVolumeService_DeleteNullVolume_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPatch, pattern_NullVolumeService_UpdateNullVolume_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_NullVolumeService_ListNullVolumes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_NullVolumeService_GetNullVolume_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodGet, pattern_NullVolumeService_StatsNullVolume_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "NullVolumeServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
