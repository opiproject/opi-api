...
var file_storage_backend_malloc_proto_rawDesc = []byte{
...
var (
	...
	file_storage_backend_malloc_proto_rawDescData = file_storage_backend_malloc_proto_rawDesc
)

func file_storage_backend_malloc_proto_rawDescGZIP() []byte {
	file_storage_backend_malloc_proto_rawDescOnce.Do(func() {
		file_storage_backend_malloc_proto_rawDescData = protoimpl.X.CompressGZIP(file_storage_backend_malloc_proto_rawDescData)
	})
...
func file_storage_backend_malloc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_storage_backend_malloc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_storage_backend_malloc_proto_rawDesc = nil
