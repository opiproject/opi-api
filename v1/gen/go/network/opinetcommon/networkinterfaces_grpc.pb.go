...
func (c *netInterfaceServiceClient) GetNetInterface(ctx context.Context, in *GetNetInterfaceRequest, opts ...grpc.CallOption) (*NetInterface, error) {
	...
	err := c.cc.Invoke(ctx, NetInterfaceService_GetNetInterface_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *netInterfaceServiceClient) ListNetInterfaces(ctx context.Context, in *ListNetInterfacesRequest, opts ...grpc.CallOption) (*ListNetInterfacesResponse, error) {
	...
	err := c.cc.Invoke(ctx, NetInterfaceService_ListNetInterfaces_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *netInterfaceServiceClient) UpdateNetInterface(ctx context.Context, in *UpdateNetInterfaceRequest, opts ...grpc.CallOption) (*NetInterface, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NetInterface)
	err := c.cc.Invoke(ctx, NetInterfaceService_UpdateNetInterface_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNetInterfaceServiceServer must be embedded to have
...
func (UnimplementedNetInterfaceServiceServer) testEmbeddedByValue()                             {}
...
func RegisterNetInterfaceServiceServer(s grpc.ServiceRegistrar, srv NetInterfaceServiceServer) {
	// If the following call pancis, it indicates UnimplementedNetInterfaceServiceServer was
...
var NetInterfaceService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "network/opinetcommon/networkinterfaces.proto",
}
