...
// UnimplementedVrfServiceServer must be embedded to have
...
var VrfService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "network/evpn-gw/l3_xpu_infra_mgr.proto",
}
...
func (c *sviServiceClient) CreateSvi(ctx context.Context, in *CreateSviRequest, opts ...grpc.CallOption) (*Svi, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Svi)
	err := c.cc.Invoke(ctx, SviService_CreateSvi_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sviServiceClient) ListSvis(ctx context.Context, in *ListSvisRequest, opts ...grpc.CallOption) (*ListSvisResponse, error) {
	...
	err := c.cc.Invoke(ctx, SviService_ListSvis_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sviServiceClient) GetSvi(ctx context.Context, in *GetSviRequest, opts ...grpc.CallOption) (*Svi, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Svi)
	err := c.cc.Invoke(ctx, SviService_GetSvi_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sviServiceClient) DeleteSvi(ctx context.Context, in *DeleteSviRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SviService_DeleteSvi_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sviServiceClient) UpdateSvi(ctx context.Context, in *UpdateSviRequest, opts ...grpc.CallOption) (*Svi, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Svi)
	err := c.cc.Invoke(ctx, SviService_UpdateSvi_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSviServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedSviServiceServer) testEmbeddedByValue()                    {}
...
func RegisterSviServiceServer(s grpc.ServiceRegistrar, srv SviServiceServer) {
	// If the following call pancis, it indicates UnimplementedSviServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
