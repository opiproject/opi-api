...
func (c *logicalBridgeServiceClient) CreateLogicalBridge(ctx context.Context, in *CreateLogicalBridgeRequest, opts ...grpc.CallOption) (*LogicalBridge, error) {
	...
	err := c.cc.Invoke(ctx, LogicalBridgeService_CreateLogicalBridge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicalBridgeServiceClient) ListLogicalBridges(ctx context.Context, in *ListLogicalBridgesRequest, opts ...grpc.CallOption) (*ListLogicalBridgesResponse, error) {
	...
	err := c.cc.Invoke(ctx, LogicalBridgeService_ListLogicalBridges_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicalBridgeServiceClient) GetLogicalBridge(ctx context.Context, in *GetLogicalBridgeRequest, opts ...grpc.CallOption) (*LogicalBridge, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogicalBridge)
	err := c.cc.Invoke(ctx, LogicalBridgeService_GetLogicalBridge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicalBridgeServiceClient) DeleteLogicalBridge(ctx context.Context, in *DeleteLogicalBridgeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, LogicalBridgeService_DeleteLogicalBridge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logicalBridgeServiceClient) UpdateLogicalBridge(ctx context.Context, in *UpdateLogicalBridgeRequest, opts ...grpc.CallOption) (*LogicalBridge, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogicalBridge)
	err := c.cc.Invoke(ctx, LogicalBridgeService_UpdateLogicalBridge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLogicalBridgeServiceServer must be embedded to have
...
func (UnimplementedLogicalBridgeServiceServer) testEmbeddedByValue()                              {}
...
func RegisterLogicalBridgeServiceServer(s grpc.ServiceRegistrar, srv LogicalBridgeServiceServer) {
	// If the following call pancis, it indicates UnimplementedLogicalBridgeServiceServer was
...
var LogicalBridgeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "network/evpn-gw/l2_xpu_infra_mgr.proto",
}
...
func (c *bridgePortServiceClient) CreateBridgePort(ctx context.Context, in *CreateBridgePortRequest, opts ...grpc.CallOption) (*BridgePort, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BridgePort)
	err := c.cc.Invoke(ctx, BridgePortService_CreateBridgePort_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bridgePortServiceClient) ListBridgePorts(ctx context.Context, in *ListBridgePortsRequest, opts ...grpc.CallOption) (*ListBridgePortsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BridgePortService_ListBridgePorts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bridgePortServiceClient) GetBridgePort(ctx context.Context, in *GetBridgePortRequest, opts ...grpc.CallOption) (*BridgePort, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BridgePort)
	err := c.cc.Invoke(ctx, BridgePortService_GetBridgePort_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bridgePortServiceClient) DeleteBridgePort(ctx context.Context, in *DeleteBridgePortRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BridgePortService_DeleteBridgePort_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bridgePortServiceClient) UpdateBridgePort(ctx context.Context, in *UpdateBridgePortRequest, opts ...grpc.CallOption) (*BridgePort, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BridgePort)
	err := c.cc.Invoke(ctx, BridgePortService_UpdateBridgePort_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBridgePortServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedBridgePortServiceServer) testEmbeddedByValue()                           {}
...
func RegisterBridgePortServiceServer(s grpc.ServiceRegistrar, srv BridgePortServiceServer) {
	// If the following call pancis, it indicates UnimplementedBridgePortServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
