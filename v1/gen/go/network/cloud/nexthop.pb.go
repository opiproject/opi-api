...
var file_network_cloud_nexthop_proto_rawDesc = []byte{
...
var (
	...
	file_network_cloud_nexthop_proto_rawDescData = file_network_cloud_nexthop_proto_rawDesc
)

func file_network_cloud_nexthop_proto_rawDescGZIP() []byte {
	file_network_cloud_nexthop_proto_rawDescOnce.Do(func() {
		file_network_cloud_nexthop_proto_rawDescData = protoimpl.X.CompressGZIP(file_network_cloud_nexthop_proto_rawDescData)
	})
...
func file_network_cloud_nexthop_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_network_cloud_nexthop_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_network_cloud_nexthop_proto_rawDesc = nil
