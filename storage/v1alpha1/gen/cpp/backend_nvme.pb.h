...
#define GOOGLE_PROTOBUF_INCLUDED_backend_5fnvme_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_backend_5fnvme_2eproto
...
struct TableStruct_backend_5fnvme_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_backend_5fnvme_2eproto;
namespace opi_api {
namespace storage {
namespace v1 {
